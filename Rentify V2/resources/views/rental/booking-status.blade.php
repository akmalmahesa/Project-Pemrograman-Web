            ...
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-4xl font-bold">#{{ $booking->id }}</p>
                    </div>
                        ...
                        <div class="flex items-center justify-end gap-2 mt-2">
                            ...
                            @else
                                <span class="inline-flex items-center px-4 py-2 bg-gray-400 text-gray-900 rounded-full font-semibold">
                                    <i class="fas fa-ban mr-2"></i>{{ ucfirst($booking->status) }}
                                </span>
                            @endif
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="p-8">
                    <div class="flex justify-between items-start mb-6">
                        <div>
                            <h2 class="text-4xl font-bold text-gray-900">{{ $booking->vehicle->name }}</h2>
                            <p class="text-gray-600 text-xl mt-2">
                                <i class="fas fa-tag mr-2 text-blue-600"></i>{{ ucfirst($booking->vehicle->type) }}
                            </p>
                        </div>
                        @if($booking->vehicle->rating)
                            <div class="bg-yellow-50 rounded-lg p-4 text-center">
                                <p class="text-4xl font-bold text-yellow-500">{{ $booking->vehicle->rating }}</p>
                    ...
                    <div class="grid grid-cols-2 gap-4 py-6 border-y border-gray-200">
                        <div class="p-4 bg-gray-50 rounded-lg">
                            ...
                            <p class="text-lg font-semibold text-gray-900 mt-2">
                                <i class="fas fa-cogs mr-2 text-blue-600"></i>{{ ucfirst($booking->vehicle->transmission ?? 'Manual') }}
                            </p>
                        </div>
                        <div class="p-4 bg-gray-50 rounded-lg">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex gap-6 pb-6 border-b border-gray-200">
                        ...
                        <div class="flex-grow">
                            ...
                            <p class="text-gray-600 mt-1">
                                ...
                                Lokasi Jemput: <strong>{{ $booking->pickup_location }}</strong>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-6 pb-6 border-b border-gray-200">
                        ...
                        <div class="flex-grow">
                            ...
                            <p class="text-2xl font-bold text-blue-600 mt-1">{{ $booking->total_days }} Hari</p>
                            <p class="text-gray-600 mt-1">
                    ...
                    <div class="flex gap-6">
                        ...
                        <div class="flex-grow">
                            ...
                            <p class="text-gray-600 mt-1">
                                ...
                                Lokasi Pengembalian: <strong>{{ $booking->return_location }}</strong>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 shadow-lg border border-green-200">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between pb-4 border-b border-green-200">
                        ...
                        <span class="font-semibold text-gray-900">{{ $booking->total_days }} hari</span>
                    </div>
