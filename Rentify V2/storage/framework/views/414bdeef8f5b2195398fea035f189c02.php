...
<?php $__env->startSection('title', 'Detail Penyewa - Sewa Kendaraan'); ?>
...
<div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
    ...
    <div class="lg:col-span-8">
        ...
        <div class="bg-white shadow-lg rounded-2xl p-8 mb-6">
            ...
            <form method="POST" action="<?php echo e(route('rental.checkout', $vehicle->id)); ?>" class="space-y-6" id="detailForm">
                <?php echo csrf_field(); ?>

                
                <input type="hidden" name="pickup_location" value="<?php echo e($data['pickup_location']); ?>">
                <input type="hidden" name="return_location" value="<?php echo e($data['return_location']); ?>">
                ...
                <input type="hidden" name="delivery_method" value="<?php echo e($data['delivery_method']); ?>">
                <input type="hidden" name="delivery_zone" value="<?php echo e($data['delivery_zone'] ?? ''); ?>">
                <input type="hidden" name="delivery_address" value="<?php echo e($data['delivery_address'] ?? ''); ?>">
...
<?php echo $__env->make('layouts.rental', ['step' => 2], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Nnesa\webRentify\resources\views/rental/detail.blade.php ENDPATH**/ ?>